...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
  ...
  public static final class UnsafeCursor implements Closeable {
     ...
     *
     * <p>Warning: it its the caller’s responsibility to either write new data to every byte of the
     ...
     *
     * @param minByteCount the size of the contiguous capacity. Must be positive and less than the
     *     capacity size of a single segment (8 KiB).
